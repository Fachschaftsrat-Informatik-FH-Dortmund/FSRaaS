...
Zu Schritt 6: Der Stundenplan-Raumabgleich (SCHED-F-410 bis F-450) gehört fachlich zum Stundenplan, wird aber hier umgesetzt, weil er den Raumplan-Zwischenspeicher aus RAUM voraussetzt. Vorab ist der Spike aus `../../openspec/specs/integrations/spec.md` INT-009 zu klären (bildet der Raumplan kurzfristige Ausfälle/Raumänderungen ab?); fällt er negativ aus, bleiben Ansicht laufender Veranstaltungen und Abgleichhinweis auf den Sollplan beschränkt.
