...
implemented_in:
  ...
  - backend/src/Fb4.Backend/Infrastructure/Mensa   # INT-015-Zwischenspeicher (MENSA-F-160: Gericht ohne Quell-Kategorie), Gerichtsnormalisierung (RATE-F-050), Aktualisierungs-Job
  - app/src/areas/canteen                          # Screens, Speiseplan, Mensaauswahl, lokale Benachrichtigung, MENSA-F-160 (Gruppierung ohne Quell-Kategorie) — sonst Stand vor der Überarbeitung vom 2026-09-04, siehe Erläuterung „Umsetzungsstand"
related:
...
**Umsetzungsstand nach der Überarbeitung vom 2026-09-04.** Die Spec ist von `implemented` auf `accepted` zurückgesetzt: Der in Roadmap-Schritt 4 gelieferte Code setzt die vorige Fassung um (eine Mensa je Ansicht, Stern-Markierung nach MENSA-F-080) und deckt MENSA-F-012 bis F-018, F-042 bis F-046, F-049, F-085/F-087, F-105, F-120 bis F-150, F-170 bis F-215 (Unverträglichkeiten-Filter, ergänzt am 2026-09-04) sowie F-220/F-230 (Preisgruppe, ebenfalls ergänzt am 2026-09-04) und F-240/N-020 (Herunterziehen zum Aktualisieren, serverseitige Auffrischung zu den Nutzungsspitzen, ergänzt am 2026-09-04) noch nicht ab. Bis zur Nachführung bestehen im Code Tests, die die entfallene MENSA-F-080 im Namen tragen — ein bewusst in Kauf genommener und hier dokumentierter Rückstand aus einer reinen Spec-Änderung, kein unbemerktes Auseinanderlaufen (`platform/quality-and-testing.md` Abschnitt 7). Die Nachführung erfolgt in zwei Teilen: Ansicht, Datumsgrenzen, Alle-Mensen-Ansicht, Unverträglichkeiten-Filter und Preisgruppe unabhängig von Schritt 9, Lieblingsgerichte gemeinsam mit den Bewertungen in Schritt 9 (`product/roadmap.md`).
...
| MENSA-N-020 | Der Speiseplan-Zwischenspeicher des Backends (`platform/backend-and-api.md` API-F-076) sollte vor der morgendlichen und vor der mittäglichen studentischen Nutzungsspitze je einmal aus INT-015 aufgefrischt worden sein, damit der in der App angezeigte Plan die tatsächliche Tagesausgabe abbildet, bevor die meisten Studierenden nachsehen. | NEU |
