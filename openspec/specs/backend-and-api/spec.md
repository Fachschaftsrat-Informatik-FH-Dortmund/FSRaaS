...
Das System muss die Raumtermine über den Platzhalter-Aufruf aus INT-009 periodisch abrufen und der App ausschließlich aus dem eigenen Zwischenspeicher ausliefern. Herkunft: Recherche: alte apps/android-fb4, retrofit/TimetableApi.java, 2026-08-25 (vormals API-F-045).

#### Scenario: Periodischer Abruf
- **WHEN** der periodische Hintergrund-Job für Raumtermine läuft
- **THEN** ruft er alle Raumtermine über den Platzhalter-Aufruf aus INT-009 ab und legt sie im eigenen Zwischenspeicher ab
