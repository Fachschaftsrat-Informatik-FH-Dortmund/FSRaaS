...
- [x] 1.6 Leitfrage aus Roadmap-Schritt 6 beantwortet: Ausfälle werden **nicht** abgebildet, Nachweis über Pfingstmontag und Fronleichnam
...
- [x] 2.1 `integrations` INT-009 — `From`/`To`, Standardfenster, Bedeutung des Sterns je Ressource, Pseudoraum im Namensfeld, Serien gegen Einzeltermine, fehlende Ausfallabbildung, Grenzen als Prüfungsquelle
...
- [ ] 4.2 Stundenplan-Raumabgleich (`schedule`, vormals SCHED-F-410 bis F-450): Ausfallhinweise sind aus dieser Quelle nicht ableitbar — Zuschnitt der sechs Requirements entscheiden
...
- [ ] 5.3 Einzelfall-Nachweis an einer bekannten Absage, ob der Termin im Bestand stehen bleibt
