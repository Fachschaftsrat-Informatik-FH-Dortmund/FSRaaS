...
**Der Raumplan bildet Ausfälle nicht ab.** Das ist die klarste Antwort des Spikes. Über die Vorlesungszeit SoSe 2026 ist die Zahl der Kursinstanzen je Wochentag praktisch konstant — jeder Montag 166 oder 167, jeder Dienstag 214 bis 216, jeder Freitag durchgängig 95. Entscheidend: **Pfingstmontag (25.05.2026) trägt 167 Kursinstanzen, exakt so viele wie der Montag darauf; Fronleichnam (04.06.2026) trägt 174, exakt so viele wie der Donnerstag darauf.** Ein Bestand, der nicht einmal gesetzliche Feiertage ausnimmt, bildet keine kurzfristigen Ausfälle ab. Der Instanzbestand ist eine mechanische Ausmultiplikation der Serien; die wenigen Tagesabweichungen (189 statt 192 am 24.06., 214 statt 216 am 14.07.) bleiben Einzelfälle. **Die Leitfrage aus Roadmap-Schritt 6 ist negativ beantwortet.**
...
**Was bleibt vom Stundenplan-Raumabgleich?** Die sechs Requirements (`schedule`, vormals SCHED-F-410 bis F-450) sollen Raumänderungen und Ausfälle erkennen. Ausfälle kann der Raumplan nicht liefern — er führt selbst Feiertage als belegt. Bleibt der Abgleich auf Raumänderungen beschränkt, und auch dort ist er schwach: Beide Seiten des Vergleichs stammen aus demselben Sollplan, der persönliche Plan aus INT-002, der Raumplan aus derselben Datenbasis. Die Requirements sind ausdrücklich als experimentelles Feature geführt, das unvollständig bleiben darf — ob sie mit diesem Befund noch tragen, ist zu entscheiden.
