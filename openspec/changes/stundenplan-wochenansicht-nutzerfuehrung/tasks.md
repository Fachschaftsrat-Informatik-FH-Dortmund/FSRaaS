...
- [ ] 5.1 Kopfzeilen-Element und Blatt mit Zeitachse-Umschalter, Sprung zu heute, Alternativen-Schalter, Farbautomatik, Zugang zur Einrichtung und den beiden Löschaktionen; Tests `describe('Ansichts- und Verwaltungsblatt in der Kopfzeile', …)` für beide Szenarien — Blatt, Zeitachse-Umschalter, Sprung zu heute, Einrichtung und beide Löschaktionen umgesetzt (`VerwaltungsblattZugang.tsx`); Alternativen-Schalter und Farbautomatik fehlen noch, da sie die Blöcke 7 und 8 voraussetzen
