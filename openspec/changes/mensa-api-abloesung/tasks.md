...
- [ ] 4.1 Öffnungszeiten aus der Stammdatenpflege entfernen, Anzeigereihenfolge und Standardauswahl belassen. Verifikation: Test `Pflege der Stammdaten-Listen` belegt, dass ein Mensa-Eintrag kein Öffnungszeitenfeld mehr annimmt.
- [ ] 4.2 Mitgelieferten Ausgangsbestand `app/src/areas/canteen/assets/stammdaten-ausgangsbestand.json` ohne `oeffnungszeiten` neu erzeugen. Verifikation: Test `Ausgangsbestand bei nicht ladbarer Mensa-Liste` läuft unverändert grün.

## 5. App — Öffnungs- und Schließzustände

- [ ] 5.1 Öffnungszeiten aus der Schnittstelle beziehen und je Wochentag anzeigen. Verifikation: Test `Öffnungszeiten je Mensa und Wochentag`.
- [ ] 5.2 Ausgabezeit zusätzlich ausweisen, wenn sie abweicht. Verifikation: Test `Ausweis der Ausgabezeit bei abweichender Öffnungszeit` mit den Werten des Max-Ophüls-Platzes (offen ab 08:00, Ausgabe ab 11:30) und der Hauptmensa (keine Abweichung).
