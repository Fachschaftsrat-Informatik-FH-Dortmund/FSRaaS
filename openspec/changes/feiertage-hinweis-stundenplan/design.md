...
**Berechnung statt Liste oder API.** Gesetzliche Feiertage in Deutschland sind für ein gegebenes Bundesland und Jahr vollständig deterministisch: acht Tage sind fest im Kalender (Neujahr, Tag der Arbeit, Tag der Deutschen Einheit, 1./2. Weihnachtstag, sowie die NRW-spezifischen Fronleichnam, Reformationstag, Allerheiligen), fünf sind über die Gaußsche Osterformel aus dem Ostersonntag abgeleitet (Karfreitag, Ostermontag, Christi Himmelfahrt, Pfingstmontag, und Fronleichnam selbst über Ostern +60 Tage). Eine Berechnung braucht keine jährliche Pflege und keinen Netzzugriff — im Gegensatz zu einer vom FSR gepflegten Liste (verworfen, siehe proposal.md) oder einer externen Feiertags-API (verworfen: neue Fremdsystem-Abhängigkeit für deterministisch berechenbare Daten, bräuchte einen eigenen Eintrag in `integrations/spec.md` samt Verfügbarkeits-/SLA-Einschätzung ohne Gegenwert).
