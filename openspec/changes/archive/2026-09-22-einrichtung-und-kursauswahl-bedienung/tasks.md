...
- [x] 6.4 Gerätetest des Wegs Einrichtung → Modulauswahl → Gruppenkennung → Planungsmodus, einschließlich der Bestätigung, dass die Kopfzeilen-Symbole auf dem Gerät erscheinen (proposal.md, „Erfüllte Voraussetzung"). Verifikation: datiertes Prüfprotokoll unter `specs/pruefprotokolle/`.
